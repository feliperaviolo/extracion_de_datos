...
def extraccion_info(pdf_file_path):
    ...
    with open(pdf_file_path,'rb') as file:
        ...
        #Extresiones Regulares (cambiar para buscar en las facturas los datos que se quieren encontrar)
...
if __name__ == "__main__":
    folder_path = "Facturas" #Colocar el nombre de la carpeta donde se localizan las facturas que no fueron Procesada
    ...
    for file in files:
        ...
        archivo_excel = 'Libro2.xlsx' #Colocar el nombre del Excel
        ...
        realizado_file = "Faturas_vista" #Colocar nombre de la carpetaa donde van las facturas que fueron Procesadas
